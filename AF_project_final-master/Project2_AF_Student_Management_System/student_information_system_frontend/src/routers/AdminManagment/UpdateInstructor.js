...
export default class UpdateInstructor extends Component
{
    ...
    componentDidMount() {
        axios.get('http://localhost:5000/instructor/edit/'+this.props.match.params.id)
            .then(response => {
                this.setState({
                    staffid:response.data.staffid,
                    instructorname:response.data.instructorname,
                    mobileno:response.data.instructormobileno,
                    address:response.data.instrucoraddress,
                    dob:response.data.instructordob,
                    state1:response.data.instructorstate,
                    instructorage:response.data.instuctorage,
                    instructorgender:response.data.instructorgender,
    ...
    onSubmit(e)
    {
        ...
        axios.post('http://localhost:5000/instructor/update/'+this.props.match.params.id, meo)
